...
namespace kim\present\virtualchest\task;
...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/VirtualChest-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = VirtualChest::getInstance()->getDataFolder() . ".latestCache";
	}
	...
	public function onCompletion(Server $server) : void{
		$plugin = VirtualChest::getInstance();
